...
class SignInViewModel {
  ...
  static SignInViewModel fromStore(Store<AppState> store){
    return SignInViewModel(
        ...
        validateEmail: (email) => store.dispatch(new ValidateEmailAction(email,ScreenState.SIGNIN)),
        validatePassword: (password) =>store.dispatch(new ValidatePasswordAction(password,ScreenState.SIGNIN)),
